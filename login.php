...
define('GOOGLE_REDIRECT_URI', strpos($_SERVER['HTTP_HOST'], 'localhost') !== false ? 'https://wastescanai-frontend-production-bf6b.up.railway.app' : $current_domain . '/login.php'); 
